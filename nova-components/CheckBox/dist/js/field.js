...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-check-box', __webpack_require__(3));
  Vue.component('detail-check-box', __webpack_require__(6));
  Vue.component('form-check-box', __webpack_require__(9));
});
